...
function Footer() {
  return (
    <footer
      style={{ backgroundColor: "#174873", position: "relative " }}
      className="text-white pt-5"
    >
      <img
        className="d-none d-md-block"
        src="./Footer/lines-top (7).png"
        style={{ position: "absolute", left: "0", top: "0", width: "100%" }}
      />
      <img
        className="d-block d-md-none"
        src="./Footer/lines-bottom (7).png"
        style={{ position: "absolute", left: "0", top: "0", width: "100%" }}
      />
      <div
        className="container pb-4 border-bottom border-secondary"
      ...
      >
        ...
        {/* <img
          className="d-none d-md-block"
          src="./Footer/footertriangle.png"
          alt=""
          style={{ position: "absolute", top: "28%", left: "100%" }}
        /> */}
      </div>
      ...
      <div className="container py-4  mt-4">
        ...
        <img
          className="d-block d-md-none"
          src="./Footer/footertrianglemobile.png"
          style={{ position: "absolute", top: "87%", left: "70%" }}
        />
      </div>
    </footer>
  );
